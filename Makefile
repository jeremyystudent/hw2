...
product_parser.o: product_parser.cpp product_parser.h product.h movie.h book.h clothing.h
...
stage1: book.o clothing.o movie.o
stage2: product_parser.o
stage3: mydatastore.o
