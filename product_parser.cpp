...
{
    std::string id = categoryID();
    return new Book(id , prodName_, price_, qty_, isbn_, author_);
}
...
{
    std::string id = categoryID();
    return new Clothing(id, prodName_, price_, qty_, size_, brand_);
}
...
{
    std::string id = categoryID();
    return new Movie(id, prodName_, price_, qty_, genre_, rating_);
}
